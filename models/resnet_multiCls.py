...
if __name__ == '__main__':
    ...
    net = resnet32x4_multiCls(num_classes=100)
    ...
    print(f"Total parameters: {total_params}")  # 输出总参数数量


    # Total parameters: 7433860
    # Total parameters: 1233540
