...
def parse_option():
    ...
    parser.add_argument('--path_t', type=str, default="D:/papers/code/RepDistiller-master-MultiCls_T_S/scripts/save/resnet32x4_vanilla/ckpt_epoch_240.pth", help='teacher model snapshot')

    # distillation
    parser.add_argument('--distill', type=str, default='kd', choices=['kd', 'hint', 'attention', 'similarity',
                                                                      'correlation', 'vid', 'crd', 'kdsvd', 'fsp',
                                                                      'rkd', 'pkt', 'abound', 'factor', 'nst'])
    parser.add_argument('--trial', type=str, default='skp_01', help='trial id')
